...
public class MapTest {
	...
	public User computeIfPresent() {
		User computeIfPresent = userRepository.getAllToMap()
				.computeIfPresent(9L, (k, v) -> new User());
		return computeIfPresent;
	}


	public User merge() {
		User user = userRepository.getAllToMap()
				.merge((long) 8, new User(), (value, newValue) -> new User());
		return user;
	}
	...
	public static void main(String[] args) {
		...
		mapTest.userRepository.getAllToMap()
